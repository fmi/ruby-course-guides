...
Темите за проект се избират от студентите и не се дават от преподавателския екип. За избора на тема има срок, който обикновено е преди коледно-новогодишните празници на зимния семестър. Обясява се по време на лекции и като новина на сайта.

Изборът на тема става като преди края на посочения срок, се изпрати [имейл до екипа на курса](http://fmi.ruby.bg/team) с предложението за тема и техническото му описание, за да се придобие представа дали сложността на проекта отговаря на изискванията.

Предварителния избор на тема на проекта има няколко функции:

- Постига се съгласие с екипа на куса, че сложността на проекта ще е достатъчно голяма, без да е непостижимо сложен за рамките на курсов проект и за времето, с което разполагате.
...
Кодът на проекта е публичен. Вижте секцията за version control в този документ.

Срокът за написване на проектите е датата за защита през сесията.

### Основна цела на проекта
...
### Какво да има в предложеието за тема
